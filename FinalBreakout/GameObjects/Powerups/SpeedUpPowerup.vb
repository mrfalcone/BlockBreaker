' SpeedUpPowerup
' ---
' Inherits Powerup to model a powerup causing the ball to speed up.
' 
...
Public NotInheritable Class SpeedUpPowerup
    Inherits Powerup
    ...
    Private Const cSpeedupAmount As Double = 1.3
    ...
    ''' <remarks></remarks>
    Public Sub New()
        MyBase.New(PowerupType.SpeedUp, cTimeLimit, cPointValue)
    End Sub
    ...
    Public Overrides Sub Activate(ByRef game As BreakoutGame)
        ...
        game.Ball.SpeedMultiplier += cSpeedupAmount
